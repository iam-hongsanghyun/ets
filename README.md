...
| [docs/multi-commodity-guide.md](docs/multi-commodity-guide.md) | How to build, run, and read a multi-commodity (steel↔carbon) model — the levers, leakage, and the CBAM cap-preserving vs OBA cap-relaxing contrast |
