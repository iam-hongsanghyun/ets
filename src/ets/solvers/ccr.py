...
class CCRCapRule:
    ...
    is lifted VERBATIM from the per-year CCR block of
    ``solvers/simulation.py:_simulate_path_details`` (flag + start-year
    ...
    Algorithm:
        ...
        (Symbols and units: see the module docstring; the signal is LAGGED —
        period-(t-1) realised emissions and abatement cost.)
